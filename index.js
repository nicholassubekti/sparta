...
// Individual list items cascade animation
sr.reveal('.cost__includes .cost__list li', {
    delay: 500,
    distance: '20px',
    origin: 'bottom',
    interval: 100,
...
sr.reveal('.cost__not__includes .cost__list li', {
    delay: 500,
    distance: '20px',
    origin: 'bottom',
    interval: 100,
...
sr.reveal('.cost__complimentary .cost__list li', {
    delay: 500,
    distance: '20px',
    origin: 'bottom',
    interval: 100,
...
// Variation 2: Slide from left
sr.reveal(`.hotel__notes`, {
    delay: 300,
    interval: 100,
    distance: '30px',
    origin: 'bottom'
...
document.addEventListener('DOMContentLoaded', () => {
    const scrollUp = document.getElementById('scroll-up');
    const isAboutPage = window.location.pathname.includes('about_indonesia.html');
    const targetSection = isAboutPage ? 'about' : 'home';
